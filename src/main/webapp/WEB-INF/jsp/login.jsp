...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="resources/resources/js/html5shiv.js"></script>
    <script src="resources/resources/js/respond.min.js"></script>
    <![endif]-->       
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +0169.8235.132</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> tranduynguyensiclc@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
    ...
    <script src="resources/resources/js/jquery.js"></script>
	<script src="resources/resources/js/price-range.js"></script>
    <script src="resources/resources/js/jquery.scrollUp.min.js"></script>
	<script src="resources/resources/js/bootstrap.min.js"></script>
    <script src="resources/resources/js/jquery.prettyPhoto.js"></script>
