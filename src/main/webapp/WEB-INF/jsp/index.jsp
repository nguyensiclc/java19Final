...
<head>
    ...
    <title>Trang Chủ | Chợ Trời</title>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.jsp"><img src="resource/images/home/logo.png" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="#"><i class="fa fa-star"></i> Quản Lí Sản Phẩm</a></li>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Chợ Trời<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href=#>Mua</a></li>
										<li><a href=#>Bán</a></li> 
                                    </ul>
                                </li> 
								<li><a href="404.html">Báo Cáo</a></li>
								<li><a href="contact-us.html">Liện Hệ Admin</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
